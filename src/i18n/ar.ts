...
export const ar: Translations = {
  ...
  landing: {
    ...
    features: {
      ...
      audio: {
        title: "تسجيل الصوت",
        description: "التقط صوت الميكروفون والنظام. اجمع بين المصدرين لتسجيلات احترافية.",
      },
      webcam: {
        title: "كاميرا الويب",
        description: "أضف عرض كاميرا الويب كنافذة صغيرة لإضفاء طابع شخصي على تسجيلاتك.",
      },
      controls: {
        title: "تحكم كامل",
