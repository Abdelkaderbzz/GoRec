  ...
  landing: {
    ...
    features: {
      ...
      screen: {
        ...
        description:
          'Record your entire screen, a window, or a specific tab with crystal-clear quality.',
      },
      audio: {
        title: 'Audio Recording',
        description:
          'Capture microphone and system audio. Mix both sources for professional recordings.',
      },
      webcam: {
        title: 'Webcam Overlay',
        description:
          'Add a picture-in-picture webcam view to personalize your recordings.',
      },
      controls: {
        title: 'Full Control',
        description:
          'Pause, resume, and manage your recordings with intuitive controls.',
      },
    },
