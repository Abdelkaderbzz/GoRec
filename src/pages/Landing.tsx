      ...
      <section className="pt-32 pb-20 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            <Button asChild size="lg" className="bg-gradient-to-r from-primary to-accent hover:opacity-90 glow-primary text-lg px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map(({ icon: Icon, key }, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-semibold mb-2">{t.landing.features[key].title}</h3>
